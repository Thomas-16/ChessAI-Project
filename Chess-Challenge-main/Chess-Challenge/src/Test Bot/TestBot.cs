...
namespace ChessChallenge.Example
{
    ...
    public class TestBot : IChessBot
    {
        ...
        int EvaluateBoard() {
            ...
            //    score += ((whitePawnShieldMissingCount * -20f) - (blackPawnShieldMissingCount * -20f)) * pawnShieldMultiplier;
            //}
        ...
        void OrderMoves(Board board, ref Span<Move> legals, ref Span<ScoredMove> prioritizedMoves, Entry trans) {
            ...
            foreach (var lmove in legals) {
                ...
                moveScore += ((0x0953310 >> 4 * (int)lmove.CapturePieceType) & 0xf) * 100f;
